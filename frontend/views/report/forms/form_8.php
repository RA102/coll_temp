    ...
    <div class="units-row">
        <table style="font-size: 14pt">
            ...
            <tr>
                ...
                <td style="font-weight: bold;">Результат специального или творческого экзамена по программам</td>
                <td style="font-weight: bold;">Дата специального или творческого экзамена</td>
            </tr>

            </thead>
            <tbody>
            <?php foreach ($entrants as $entrantIndex => $entrant) { ?>
                <?php $exam = current($receptionGroup->receptionExams) ?>
                <tr>
