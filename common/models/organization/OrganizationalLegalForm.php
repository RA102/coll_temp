...
/**
 * This is the model class for table "organization.organizational_legal_form".
 *
 * @property int $id
 ...
 */
class OrganizationalLegalForm extends \yii\db\ActiveRecord
{
    ...
    {
        return 'organization.organizational_legal_form';
    }
